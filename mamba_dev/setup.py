...
def get_hip_version(rocm_dir):
    ...
    for line in raw_output.split("\n"):
        if "HIP version" in line:
            rocm_version = parse(
                line.split()[-1].rstrip('-').replace('-', '+'))  # local version is not parsed correctly
...
if not SKIP_CUDA_BUILD:
    ...
    ext_modules.append(
        CUDAExtension(
            name="selective_scan_cuda_positive",
            sources=[
                "csrc/selective_scan_positive/selective_scan.cpp",
                "csrc/selective_scan_positive/selective_scan_fwd_fp32.cu",
                "csrc/selective_scan_positive/selective_scan_fwd_fp16.cu",
                "csrc/selective_scan_positive/selective_scan_fwd_bf16.cu",
                "csrc/selective_scan_positive/selective_scan_bwd_fp32_real.cu",
                "csrc/selective_scan_positive/selective_scan_bwd_fp32_complex.cu",
                "csrc/selective_scan_positive/selective_scan_bwd_fp16_real.cu",
                "csrc/selective_scan_positive/selective_scan_bwd_fp16_complex.cu",
                "csrc/selective_scan_positive/selective_scan_bwd_bf16_real.cu",
                "csrc/selective_scan_positive/selective_scan_bwd_bf16_complex.cu",
            ],
            extra_compile_args=extra_compile_args,
            include_dirs=[Path(this_dir) / "csrc" / "selective_scan_positive"],
        )
    )
    ext_modules.append(
        CUDAExtension(
            name="selective_scan_cuda_positive_and_negative",
            sources=[
                "csrc/selective_scan_positive_and_negative/selective_scan.cpp",
                "csrc/selective_scan_positive_and_negative/selective_scan_fwd_fp32.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_fwd_fp16.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_fwd_bf16.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_bwd_fp32_real.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_bwd_fp32_complex.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_bwd_fp16_real.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_bwd_fp16_complex.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_bwd_bf16_real.cu",
                "csrc/selective_scan_positive_and_negative/selective_scan_bwd_bf16_complex.cu",
            ],
            extra_compile_args=extra_compile_args,
            include_dirs=[Path(this_dir) / "csrc" / "selective_scan_positive_and_negative"],
        )
    )
